  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "timestamp.proto\032\034google/api/annotations.proto\"\216\003\n"
          ...
          + "$notebooks.g"
          + "oogleapis.com/Environment\022-projects/{project}/environments/{environment}B\014\n\n"
          + "image_type\"V\n"
          + "\007VmImage\022\024\n"
          ...
          + "\"com.google.cloud.notebooks.v1beta1B\020Environme"
          + "ntProtoP\001ZGgoogle.golang.org/genproto/googleapis/cloud/notebooks/v1beta1;noteboo"
          + "ks\252\002\036Google.Cloud.Notebooks.V1Beta1\312\002\036Go"
          + "ogle\\Cloud\\Notebooks\\V1beta1\352\002!Google::Cloud::Notebooks::V1beta1b\006proto3"
    };
    descriptor =
